...
parse_atom = property $ do
  ...
  readSmiles' str === Right (G 1 $ mkGraph [a] Nil)
...
parse_bond = property $ do
  ...
  let str = "\{a1}\{b}\{a2}"
  footnote "Encoded: \{str}"
  readSmiles' str === Right (G 2 $ mkGraph [a1, a2] [E 0 1 b])
...
parse_branch = property $ do
  ...
  footnote "Encoded: \{str}"
  readSmiles' str === Right (G 3 $ mkGraph [a1, a2, a3] [E 0 1 b1, E 0 2 b2])
...
parse_ring = property $ do
  ...
  footnote "Encoded: \{str}"
  readSmiles' str === Right (G 2 $ mkGraph [a1,a2] [E 0 1 b1])
